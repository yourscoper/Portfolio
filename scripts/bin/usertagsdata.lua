    ...
    RankData = {
        ...
        ["OWNER"] = {
            ...
            accent             = ColorSequence.new{
                ...
                ColorSequenceKeypoint.new(1,   Color3.fromRGB(220, 75, 75 )),
            },
            ...
            bordergradient     = ColorSequence.new{
                ...
                ColorSequenceKeypoint.new(0.25, Color3.fromRGB(255, 235, 235)),
                ColorSequenceKeypoint.new(0.5,  Color3.fromRGB(90,  20, 20 )),
                ColorSequenceKeypoint.new(0.75, Color3.fromRGB(255, 180, 180)),
                ColorSequenceKeypoint.new(1,    Color3.fromRGB(140, 25, 25 )),
            },
            avatargradient     = ColorSequence.new{
                ColorSequenceKeypoint.new(0,    Color3.fromRGB(0,   0,   0  )),
                ColorSequenceKeypoint.new(0.33, Color3.fromRGB(120, 35, 35 )),
                ColorSequenceKeypoint.new(0.66, Color3.fromRGB(220, 75, 75 )),
                ColorSequenceKeypoint.new(1,    Color3.fromRGB(0,   0,   0  )),
            },
            avatarglowcolor    = Color3.fromRGB(180, 45, 45),
            ...
            glitchedname       = true,
            typewritename      = false,
            tagcolor           = Color3.fromRGB(235, 90, 90),
            crownicon          = true,
            showuserid         = false,
        },
        ...
        ["ADMIN"] = {
            ...
            glitchedname       = false,
            typewritename      = false,
            tagcolor           = Color3.fromRGB(255, 94, 94),
            crownicon          = false,
            showuserid         = false,
        },
