...
local mn=1
local mx=math.floor(ps.MaxPlayers*0.3)
local ms=1
local mr=15
local sp=8
local sb={}
...
local om=mx
mx=math.max(1,mx+(at*5))
tg,sp,lf=fl(al,vs,ft)
mx=om
end
if tg then
local pc=tg.playing
