...
b1.Name="ToggleBtn"
b1.Size=UDim2.new(0,70,0,22)
b1.Position=UDim2.new(0.5,-75,0,10)
...
b2.Name="StrictBtn"
b2.Size=UDim2.new(0,70,0,22)
b2.Position=UDim2.new(0.5,5,0,10)
...
local u5=Instance.new("UICorner")
u5.CornerRadius=UDim.new(0,6)
u5.Parent=b2
...
m2=not m2
if m2 then
f1:TweenSize(UDim2.new(0,180,0,85),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.2,true)
c5.Visible=true
else
f1:TweenSize(UDim2.new(0,180,0,25),Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.2,true)
task.wait(0.2)
c5.Visible=false
end
end)
...
local o3=o2 and o2:FindFirstChildWhichIsA("Humanoid")
local o4=o3 and o3.RootPart
if o4 and (r1.Position-o4.Position).Magnitude<2 then
for _,a2 in ipairs(o3:GetPlayingAnimationTracks()) do
if a2.Animation then
if s1 then
return o1
elseif a2.Animation.AnimationId:match("148840371") or a2.Animation.AnimationId:match("5918726674") then
return o1
end
end
end
...
b3[2].MouseButton1Click:Connect(function()
s1=not s1
b3[2].Text=s1 and "STRICT: ON" or "STRICT: OFF"
end)

p2.InputBegan:Connect(function(i1,g2)
if not g2 and i1.KeyCode==Enum.KeyCode.N then
e1=not e1
b3[1].Text=e1 and "ON" or "OFF"
end
end)
